...
const VaultApp = (() => {
  ...
  function injectStyles(){
    ...
    s.textContent=`
      ...
      .vault-tabs{padding:12px 0 10px;display:flex;align-items:center;justify-content:space-between;gap:12px}.vault-tabset{display:flex;gap:6px;flex-wrap:wrap}.vault-tabset button{height:34px;padding:0 11px;border-radius:10px;border:1px solid transparent;color:#6e7684;font-size:11px;font-weight:750}.vault-tabset button:hover{background:#fff}.vault-tabset button.active{background:#fff;border-color:#dfe3e9;color:#111827;box-shadow:0 4px 12px rgba(15,23,42,.05)}.vault-count{font-size:10px;color:#9299a5}
      ...
      .vault-compose{width:min(650px,94vw);background:#f7f8fa;border-radius:25px;box-shadow:0 34px 110px rgba(0,0,0,.24);overflow:hidden}.vault-compose-top{padding:16px 18px;background:linear-gradient(135deg,#111827,#1f2937);color:#fff;display:flex;justify-content:space-between;align-items:center}.vault-compose-body{padding:16px}.vault-compose-title{width:100%;border:0;background:transparent;font-size:22px;font-weight:850;outline:0;color:#171b22;padding:2px 0 9px}.vault-compose textarea{width:100%;min-height:145px;border:1px solid #e3e6eb;background:#fff;border-radius:15px;padding:13px;outline:0;resize:vertical;font-size:12px;line-height:1.65}.vault-compose-row{display:grid;grid-template-columns:1fr 1fr;gap:9px;margin-top:9px}.vault-compose select,.vault-compose input.meta{height:40px;border-radius:11px;border:1px solid #e1e4e9;background:#fff;padding:0 11px;font-size:11px;outline:0}.vault-color-row{display:flex;align-items:center;gap:7px;margin-top:11px}.vault-color-row button{width:30px;height:30px;border-radius:10px;border:2px solid transparent;box-shadow:inset 0 0 0 1px rgba(0,0,0,.04)}.vault-color-row button.active{border-color:#111827}.vault-smart-tags{margin-top:10px;padding:10px 11px;border-radius:13px;background:#fff;border:1px solid #e5e7eb}.vault-smart-tags .chips{display:flex;gap:5px;flex-wrap:wrap;margin-top:6px}.vault-smart-tags .chips span{font-size:9px;padding:4px 6px;border-radius:7px;background:#eef1f5;color:#5f6876}.vault-compose-foot{padding:12px 16px;border-top:1px solid #e4e7eb;display:flex;justify-content:space-between;gap:10px;background:#fff}.vault-compose-foot button{height:38px;padding:0 13px;border-radius:10px;border:1px solid #e0e4e8;background:#fff;font-size:11px;font-weight:800}.vault-compose-foot button.save{background:#111827;color:#fff;border-color:#111827}
      .vault-ask-modal{width:min(760px,94vw);background:#fff;border-radius:26px;overflow:hidden;box-shadow:0 34px 110px rgba(0,0,0,.24)}.vault-ask-modal-head{padding:20px;background:linear-gradient(135deg,#111827,#312e81);color:white}.vault-ask-modal-input{display:flex;gap:8px;margin-top:12px;background:#fff;border-radius:14px;padding:6px}.vault-ask-modal-input input{flex:1;border:0;outline:0;padding:0 8px;color:#111827;font-size:13px}.vault-ask-modal-input button{height:36px;border:0;border-radius:10px;background:#4f46e5;color:#fff;padding:0 13px;font-size:11px;font-weight:800}.vault-ask-results{padding:16px;max-height:60vh;overflow:auto}.vault-answer-card{padding:14px;border-radius:15px;background:#f5f6f8;margin-bottom:10px}.vault-answer-card b{font-size:12px}.vault-answer-card p{font-size:11px;color:#687180;white-space:pre-wrap;margin-top:5px;line-height:1.55}
      @media(max-width:760px){.vault-ask-row{flex-wrap:wrap}.vault-ask-copy{min-width:0;width:100%}.vault-ask-input{width:100%}.vault-head{align-items:flex-start}.vault-head-actions{flex-wrap:wrap;justify-content:flex-end}.vault-compose-row{grid-template-columns:1fr}.vault-grid{grid-template-columns:1fr}}
    `;
  ...
  function modal(html){document.getElementById('vaultModal')?.remove();const d=document.createElement('div');d.id='vaultModal';d.className='fixed inset-0 z-[300] bg-black/45 backdrop-blur-sm flex items-center justify-center p-5';d.innerHTML=html;document.body.appendChild(d);d.addEventListener('click',e=>{if(e.target===d)d.remove()});return d;}
