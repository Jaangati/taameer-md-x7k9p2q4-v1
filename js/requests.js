...
window.RequestsApp = (() => {
  ...
  function ensureStyle(){
    ...
    const s=document.createElement('style'); s.id='requestsStyles'; s.textContent=`
      ...
      .rq-workspace{min-height:0;padding:0 22px 20px;display:grid;grid-template-columns:1fr;overflow:hidden}.rq-panel{min-height:0;background:#fff;border:1px solid #e5e7eb;border-radius:24px;display:grid;grid-template-rows:auto auto 1fr;overflow:hidden}.dark .rq-panel{background:#0a0f18;border-color:#202938}.rq-summary{padding:16px 18px;border-bottom:1px solid #eef0f3;display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:10px}.dark .rq-summary{border-color:#1e2633}.rq-stat{padding:12px 14px;border-radius:16px;background:#f8fafc;min-width:0}.dark .rq-stat{background:#101722}.rq-stat .v{font-size:22px;font-weight:800;line-height:1}.rq-stat .l{font-size:10px;color:#7c8798;margin-top:5px;font-weight:700;text-transform:uppercase;letter-spacing:.06em}.rq-stat.alert .v{color:#dc2626}.rq-stat.review .v{color:#7c3aed}.rq-stat.completed .v{color:#16a34a}
  ...
  async function saveRequest(id=''){
    ...
    if(!title||!assignee_id)return alert(isAdmin()?'Please add a request and choose who owns it.':'Please add a request title.');
